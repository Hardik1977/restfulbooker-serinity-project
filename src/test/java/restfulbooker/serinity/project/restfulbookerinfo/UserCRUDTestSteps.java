package restfulbooker.serinity.project.restfulbookerinfo;
...
import restfulbooker.serinity.project.restfulinfo.CreateSteps;
import restfulbooker.serinity.project.restfulinfo.DeleteSteps;
import restfulbooker.serinity.project.restfulinfo.ReadSteps;
import restfulbooker.serinity.project.restfulinfo.UpdateSteps;
import restfulbooker.serinity.project.testbase.TestBase;
import restfulbooker.serinity.project.utils.TestUtils;
...
public class UserCRUDTestSteps extends TestBase {

    static String username = "admin";
    static String password = "password123";
    static String firstname = "Paresh" + TestUtils.getRandomValue();
    static String lastname = "Gohel";
    static int totalprice = 999;
    static boolean depositpaid = true;
    static String additionalneeds = "Breakfast";
    static String checkin = "2025-04-02";
    static String checkout = "2025-04-10";
