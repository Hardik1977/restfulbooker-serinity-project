package restfulbooker.serinity.project.utils;
...
public class PropertyReader {
    ...
    public String getProperty(String propertyName) {
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/resources/peropertyfiles/application.properties");
